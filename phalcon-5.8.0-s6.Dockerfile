...
ENV TZ=America/Los_Angeles PHALCON_VERSION=5.8.0 REDIS_VERSION=6.1.0 MEMCACHED_VERSION=3.3.0 YAML_VERSION=2.2.4 APCU_VERSION=5.1.24 XDEBUG_VERSION='Release 3.4.0beta1' \
ZEPHIR_PARSER_VERSION=1.7.0 IGBINARY_VERSION=3.2.16 PSR_VERSION=1.2.0 MSGPACK_VERSION=3.0.0 EVENT_VERSION=3.1.4 EV_VERSION=1.2.0
// TODO pecl/phalcon requires PHP (version >= 8.0.0, version <= 8.3.99), installed version is 8.4.1
...
# xdebug 和 phalcon 没有主动激活，移除了 inotify
# docker build -f phalcon-5.8.0-s6.Dockerfile  -t authus/phalcon:5.8.0-s6 .
