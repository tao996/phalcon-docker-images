...
ENV PHALCON_VERSION=5.6.2 REDIS_VERSION=6.0.2 MEMCACHED_VERSION=3.2.0 YAML_VERSION=2.2.3 APCU_VERSION=5.1.23 XDEBUG_VERSION=3.3.2 TZ=America/Los_Angeles \
...
# docker build -f phalcon-5.6.2.Dockerfile  -t authus/phalcon:5.6.2 .